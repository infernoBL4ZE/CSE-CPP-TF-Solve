...
{
    base *pb1,*pb2;
    base b1;derived1 d1; //For b1, base constructor is called, for d1, first the base constructor, then the derived constructor is called
    pb1=&b1;pb2=&d1;//pointers to a class can point to itself and its derived classes. But derived classes cannot point to parent classes.
    pb1->show(); pb2->show();//If virtual was not used, both would show "base"
}
*/
